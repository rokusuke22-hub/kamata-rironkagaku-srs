...
var SPREADSHEET_ID = "1Qw7GJLRA-pGXh1b0in6A3yhQBcOhmy-_inUc8Jlokhw";

// シート名（★鎌田の理論化学用。他教材と重複不可）
var SHEET_NAME_DATA = "KT_SRS_Data";    // NS/K1/EM/SP と非重複
var SHEET_NAME_META = "KT_SRS_Meta";
...
function runAllTests() {
  Logger.log("========================================");
  Logger.log("鎌田の理論化学 SRS GAS テスト実行 - " + new Date().toISOString());
  Logger.log("========================================");
...
function checkDataStatus() {
  ...
  if (sheet) {
    var lastRow = sheet.getLastRow();
    Logger.log("========================================");
    Logger.log("鎌田の理論化学 SRS データ状態チェック");
    Logger.log("========================================");
